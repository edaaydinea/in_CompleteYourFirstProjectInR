...
sales$PaymentStatus <- factor(sales$Payment.Status)
summary(sales)
```
...
sales_subset <- subset(sales, select = c(Employee.Job.Title, Sales.Region, OrderMonth, OrderYear, OrderType, ProdCategory, Quantity, Price, Discount, Order.Total, Payment.Plan, Payment.Status))
```
